...
#End Region
        ...
        Protected Sub InsertCancelButton_Click(ByVal sender As Object, ByVal e As System.EventArgs)
            DisplayFormView(False)
            grdLinks.EditIndex = -1
            grdLinks.DataBind()
        End Sub

        Protected Sub linqLinks_Inserted(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.LinqDataSourceStatusEventArgs) Handles linqLinks.Inserted
            Me.grdLinks.DataBind()
        End Sub

        Protected Sub linqLinks_Inserting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.LinqDataSourceInsertEventArgs) Handles linqLinks.Inserting
            Dim link = CType(e.NewObject, DNNCorp.ForgeDownloadManager.ForgeLink)
            link.ModuleId = Me.ModuleId
        End Sub

        Protected Sub linkReturn_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles linkReturn.Click
            Response.Redirect(NavigateURL(TabId, "Module", "ModuleId=" & ModuleId.ToString))
        End Sub

        Protected Sub linkEdit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles linkEdit.Click
            Response.Redirect(EditUrl("EditTemplates"))
        End Sub
